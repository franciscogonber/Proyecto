...
const Lista = () => {
  ...
  useEffect(() => {
    axios.get('http://localhost:8000/api/autores', {withCredentials:true}) // conectar fron con back ---los nombres de los parametros deben estar iguales a los nombre  en el modelo
      .then(respuesta => {
