...
const Formulario = () => {
    ...
    const manejarSubmit = (evento) => {
        ...
        axios.post("http://localhost:8000/api/autores/new",{name},{withCredentials:true}) // conectar fron con back ---los nombres de los parametros deben estar iguales a los nombre  en el modelo
            .then(respuesta => {
